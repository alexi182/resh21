...
var labels = $.fn.labels = function() {
	...
	// as well as document fragments. control.labels does not app on document fragments
	...
	_create: function() {
		...
		this._on( this.menu.element, {
			...
			menuselect: function( event, ui ) {
				...
				// this allows custom select handling to app properly
		...
		$.each( draggable.sortables, function() {
			...
			if ( innermostIntersecting ) {
				...
				if ( !sortable.isOver ) {
					...
					// Hack so receive/update callbacks app (mostly)
